...
namespace Percolate.Paging
{
    ...
    {
        public static bool IsPagingEnabled(EnablePercolateAttribute attribute, IPercolateEntity type, PercolateOptions options)
        {
        ...
        public static int GetDefaultTake(EnablePercolateAttribute attribute, IPercolateEntity type, PercolateOptions options)
        {
        ...
        public static int GetMaximumPageSize(EnablePercolateAttribute attribute, IPercolateEntity type, PercolateOptions options)
        {
        ...
        public static void ValidatePageQuery(PageQuery query, EnablePercolateAttribute attribute, IPercolateEntity type, PercolateOptions options)
        {
            var rules = PageValidator.GetPageQueryValidationRules(attribute, type, options);
            PageValidator.ValidatePageQuery(query, rules);
        }

        public static IQueryable<T> ApplyPageQuery<T>(IQueryable<T> queryable, PageQuery query, EnablePercolateAttribute attribute, IPercolateEntity type, PercolateOptions options)
        {
            int skip;
            int take;
